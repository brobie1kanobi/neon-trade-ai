      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <Button
            variant="destructive"
            className="w-full"
            onClick={() => alert('Account deactivation is irreversible')}
          >
        ...
        <div className="p-4 rounded-lg border border-blue-200 bg-blue-50 dark:bg-blue-900/20">
          ...
          <p className="text-xs text-blue-700 dark:text-blue-300">
            This app is designed to integrate with any trading APIs, but has been created using the Kraken Websocket and REST API. Integrate your own exchanges API at your own risk.
          </p>
        </div>
      </CardContent>
    </Card>
