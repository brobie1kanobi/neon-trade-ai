      ...
      <CardContent className="p-4">
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <a href={createPageUrl("MarketAnalysis")}>
            <Button
              variant="ghost"
              className="flex items-center gap-2 h-auto px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg"
            >
