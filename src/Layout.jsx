              ...
              <div className="flex items-end justify-center gap-1.5 sm:gap-3 md:gap-4 flex-1 pl-2 sm:pl-3 pr-7 sm:pr-0">
                {rightNavItems.map((item) => {
                  ...
                  return (
                    <Component
                      key={item.title}
                      {...props} className="rounded-lg flex flex-col items-center gap-0.5 sm:gap-1 transition-all duration-200 hover:shadow-lg justify-center shadow-sm select-none w-[46px] h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 sm:p-2 mt-1 pt-1 pb-1"
