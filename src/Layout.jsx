        ...
        style={{
          ...
          <div className="relative mx-auto w-full max-w-[95%] sm:max-w-xl md:max-w-2xl lg:max-w-3xl px-2 sm:px-4">
            ...
            <div className="pt-2 pb-4 opacity-100 flex items-end sm:pb-5">
                ...
                {leftNavItems.map((item) => {
                  ...
                  return (
                    <Component
                      key={item.title}
                      {...props}
                      className="flex flex-col items-center gap-0.5 sm:gap-1 rounded-lg transition-all duration-200 hover:shadow-lg justify-center shadow-sm select-none w-[46px] h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 px-0.5 py-1 sm:p-2 mr-1 ml-1"
                      style={{
                      ...
                      <span className="text-[9px] sm:text-xs font-medium leading-tight text-center w-full mr-1">{item.title}</span>
                    </Component>);
              ...
              {/* RIGHT group */}
              <div className="flex items-end justify-center gap-1.5 sm:gap-3 md:gap-4 flex-1 pl-2 sm:pl-3 pr-7 sm:pr-0 -translate-x-4 sm:translate-x-0">
